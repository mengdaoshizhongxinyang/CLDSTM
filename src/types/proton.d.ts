...
declare module "three.proton.js"{
  import { Scene, RenderTarget, Vector3, Texture, Euler, Vector2,Camera,Renderer } from "three";
  interface Render {
   ...
   */
    class Force extends Behaviour{
      constructor(fx?:number, fy?:number, fz?:number, life?:number, easing?:number)
    ...
    class RandomDrift extends Behaviour{
      constructor(driftX:number, driftY:number, driftZ:number, delay?:number, life?:number, easing?:string)
    }
   ...
   */
    class Rotate extends Behaviour{
      constructor(x?:number|Span|string, y?:number|Span|string, z?:number|Span|string, life?:string, easing?:string)
    }
     ...
     */
    class ScreenZone{
      constructor(camera:Camera, renderer:Renderer, dis:number, dir:string)
    }
